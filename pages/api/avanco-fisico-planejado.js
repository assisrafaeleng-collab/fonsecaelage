...
const NOMES_AMIGAVEIS = {
  'Servicos Preliminares e Gerais': 'Servi�os Preliminares e Gerais',
  'Movimento de Terra e Fundacoes': 'Movimento de Terra e Funda��es',
  'Estrutura': 'Estrutura', 'Alvenaria e Fechamentos': 'Alvenaria e Fechamentos',
  'Reboco e Emboco': 'Reboco e Embo�o',
  'Instalacoes Hidrossanitarias': 'Instala��es Hidrossanit�rias',
  'Instalacoes Eletricas e Telecom': 'Instala��es El�tricas e Telecom',
  'Instalacoes Especiais': 'Instala��es Especiais',
  'Cobertura e Impermeabilizacao': 'Cobertura e Impermeabiliza��o',
  'Aplicacao de Gesso': 'Aplica��o de Gesso', 'Pisos e Rodapes': 'Pisos e Rodap�s',
  'Esquadrias': 'Esquadrias', 'Pintura': 'Pintura',
  'Loucas Metais e Bancadas': 'Lou�as, Metais e Bancadas',
  'Urbanizacao e Paisagismo': 'Urbaniza��o e Paisagismo',
  'Locacoes e Equipamentos': 'Loca��es e Equipamentos', 'Servicos Finais': 'Servi�os Finais',
}

// Extrai cod_eap e descri��o do nome formatado "X.X.X � Descri��o"
...
function getSubgrupo(cod_eap, grupo_custo) {
  ...
  if (grupo_custo === 'Estrutura') {
    const map = { 1: 'T�rreo', 2: '2� Pavimento', 3: '3� Pavimento', 4: '4� Pavimento', 5: '5� Pavimento', 6: '6� Pavimento / Platibanda' }
    return map[subIdx] || null
  }
  if (grupo_custo === 'Alvenaria e Fechamentos') {
    const map = { 1: 'T�rreo', 2: '2� Pavimento', 3: '3� Pavimento', 4: '4� Pavimento', 5: '5� Pavimento', 6: '6� Pavimento', 7: 'Platibanda' }
    return map[subIdx] || null
  }
  return null
}
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Mapa realizado por atividade_codigo (m�ximo acumulado)
    const realizadoMap = {}
    ...
    const ORDEM_PAV = ['T�rreo', '2� Pavimento', '3� Pavimento', '4� Pavimento', '5� Pavimento', '6� Pavimento', '6� Pavimento / Platibanda', 'Platibanda']
